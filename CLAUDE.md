...
работниот простор. Сега е `datalist` — **понуда, не ограничување**, зашто
`teachers.subject` останува слободен текст и работната книга пишува кратенки
(`ФЗО.`) што серверот ги разбира преку `SUBJECT_ALIASES`. Зачуваното што
каталогот не го знае се нуди ПРВО, за да не изгледа како грешка што треба да се
поправи.
...
во НаставаУреди. Сега е поле со `datalist` од истиот каталог — **понуда, не
ограничување**: `teachers.subject` останува слободен текст, зашто работната
книга на училиштето пишува кратенки (`ФЗО.`) што серверот ги разбира преку
`SUBJECT_ALIASES`, и еден избор од мени не смее тивко да ги замени. Зачуваното
што каталогот не го знае се нуди ПРВО, за да не изгледа како грешка што треба
да се поправи.
